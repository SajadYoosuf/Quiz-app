...
Widget questionChangingButton(BuildContext context, String buttonName,
    int buttonIndex, String answer, List<QuizFullData> fullData, String heading) {
         final provider=Provider.of<QuizPageFunctions>(context);
            ...
            switch (buttonIndex) {
              ...
              case 2:
                provider.nextQuestionNavigation(
                    answer, fullData, heading, context,);
                break;
              default:
            }
          },
